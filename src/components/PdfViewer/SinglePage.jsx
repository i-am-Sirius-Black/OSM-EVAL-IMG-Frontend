...
//?testing v1 separate drawing annotation (prev)
// import { memo, useRef, useEffect, useState, useCallback } from "react";
// import checkImage from "/check.png";
// import cancelImage from "/cross.png";
// import PageSkeleton from "../Common/PageSkeleton";
...
<div className="absolute inset-0 bg-gray-200 flex items-center justify-center">
  <div className="text-center p-4">
    <div className="mx-auto bg-gray-400 rounded-full w-12 h-12 flex items-center justify-center mb-3">
      <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
      </svg>
    </div>
    <p className="text-2xl font-black text-gray-700">This Page is Masked</p>
    <p className="text-sm text-gray-500">Answer Sheet Starts from Page 3</p>
  </div>
</div>
            ) : (
              // Normal page content
