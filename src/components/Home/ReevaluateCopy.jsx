...
const ReevaluateCopy = ({  reevalCopies = [], loading = false  }) => {
        ...
        <div className="overflow-x-auto">
          {loading ? (
            <div className="text-center py-12">
              ...
              <p className="mt-2 text-sm text-gray-600">Loading reevaluation assignments...</p>
            </div>
          ) : reevalCopies.length === 0 ? (
            <div className="text-center py-12">
              {/* Empty state - keep your existing code */}
              <svg
