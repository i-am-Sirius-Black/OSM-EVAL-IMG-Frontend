...
const AssignSubjects = () => {
  ...
  //       console.log('Fetched assigned subjects:', response.data);
       
  //       setEvaluators(prev => prev.map(evaluator => {
  //         if (evaluator.id === response.data.evaluatorId) {
  //           return { ...evaluator, subjectCount: response.data.count };
  //         }
  //         return evaluator;
  //       }));
  ...
  //       setError('Failed to load evaluators. Please refresh to try again.');
  //     } finally {
  //       setLoading(prev => ({ ...prev, initial: false }));
  //     }
  //   };
